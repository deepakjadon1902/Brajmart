...
const sections = [
  ...
  { title: '3. Data Security', content: `We implement industry-standard security measures including SSL encryption, secure payment gateways (Razorpay), and regular security audits. Your payment information is never stored on our servers — it's processed directly by our PCI-DSS compliant payment partners.` },
  ...
  { title: '5. Third-Party Services', content: `We share limited data with trusted partners: shipping carriers (for delivery), payment processors (Razorpay), analytics providers (Google Analytics), and email services (for order updates). Each partner is bound by strict data protection agreements.` },
