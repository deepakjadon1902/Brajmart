  ...
  return (
    <section className="relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-card/90 backdrop-blur border-t border-gold/10">
        <div className="container mx-auto px-4 py-3 flex items-center justify-center gap-6 md:gap-10 flex-wrap text-xs font-medium text-foreground">
          <span>🏛️ Temple Authenticated</span>
